...
from models import (
    ...
    FeedQueries,
    HourlyActivityInput,
    MissionDailySummaryInput,
    MissionDailySummaryOutput,
    MissionGlobalProfileInput,
    MissionGlobalProfileOutput,
    MissionHourlySummaryInput,
    MissionHourlySummaryOutput,
    MissionMonthlySummaryInput,
    MissionMonthlySummaryOutput,
...
TASKS: Dict[str, Dict[str, Any]] = {
    ...
    "user_mission_daily_summary": {
        "input_model": MissionDailySummaryInput,
        "output_model": MissionDailySummaryOutput,
        "instruction": USER_MISSION_DAILY_SUMMARY,
        "endpoint": "/user/mission-daily-summary",
        "load_level": "medium",
    },
    "user_mission_monthly_summary": {
        "input_model": MissionMonthlySummaryInput,
        "output_model": MissionMonthlySummaryOutput,
        "instruction": USER_MISSION_MONTHLY_SUMMARY,
        "endpoint": "/user/mission-monthly-summary",
        "load_level": "medium",
    },
    "user_mission_global_profile": {
